...
def genoClassification(
    training_data, training_labels, test_data, rowNum=32, colNum=32, epoch=100
):
    ...
    net = gNet.traingenoNet(
        XTrain, yTrain, maxEPOCH=epoch, batchSize=miniBatchSize, verbose=True
    )
