...
def save_accuracy_in_file(labels_gt, labels):
    with open(
        "results/test_results_deepInsight_cls"
        + str(config.params["num_class"])
        + ".txt",
        "w",
    ) as f:
        ...
        pp_matrix(
            ...
            lw=0.5,
            figsize=[8, 6],
            save_file_name="results/deepInsight_metrics_confusion.png",
        )
        ...
        save_file_name = "results/deepInsight_precision_recall.png"
